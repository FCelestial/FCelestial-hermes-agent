...
_UPSTREAM_REPO_URL = "https://github.com/FCelestial/FCelestial-hermes-agent.git"
...
_RELEASE_URL_BASE = "https://github.com/FCelestial/FCelestial-hermes-agent/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    canonical FCelestial/FCelestial-hermes-agent fork (upstream don't get a link).
    """
